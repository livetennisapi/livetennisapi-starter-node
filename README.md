...
[![ci](https://github.com/livetennisapi/livetennisapi-starter-node/actions/workflows/ci.yml/badge.svg)](https://github.com/livetennisapi/livetennisapi-starter-node/actions/workflows/ci.yml)
...
fields `win_probability_p1` and `danger` — a `null` there means the model had
